  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-gradient-to-br from-cyan-500 to-blue-300">
      <div className="absolute inset-0 z-0 p-6 flex flex-col gap-4">
        <div className="w-24 h-24 flex flex-col items-center justify-center gap-2 rounded-lg hover:bg-white/20 transition-colors cursor-pointer">
      ...
      <div className="absolute bottom-0 left-0 w-full h-14 bg-white/20 backdrop-blur-xl border-t border-white/40 z-50 flex items-center px-4 shadow-[0_-4px_16px_rgba(0,0,0,0.1)]">
